    ...
    def handle(self, *args, **kwargs):
        ...
        figure_data = [
            ...
            },
            {
                ...
                "birth": -384,
                "death": -322,
                "fields": ["Philosophy", "Science", "Politics"],
            },
            # Renaissance Era
            {
                "name": "Leonardo da Vinci",
                "desc": "Renaissance polymath.",
                "birth": 1452,
                "death": 1519,
                "fields": ["Art", "Science", "Medicine"],
            },
            {
                "name": "William Shakespeare",
                "desc": "Greatest writer in the English language.",
                "birth": 1564,
                "death": 1616,
            ...
            {
                "name": "Ada Lovelace",
                "desc": "First computer programmer.",
                "birth": 1815,
                "death": 1852,
            ...
            {
                "name": "Marie Curie",
                "desc": "Pioneering research on radioactivity.",
                "birth": 1867,
                "death": 1934,
            ...
            },
            {
                ...
                "desc": "Theorist of relativity.",
                "birth": 1879,
                "death": 1955,
                "fields": ["Science", "Mathematics"],
            },
            # Contemporary Era (Living Figure)
            {
                "name": "Noam Chomsky",
                "desc": "Linguist, philosopher, and political activist.",
                "birth": 1928,
                "death": None,
                "fields": ["Philosophy", "Politics", "Literature"],
            },
        ]
        ...
        for data in figure_data:
            ...
            wikidata_val = f"Q-{data['name'].replace(' ', '')}-" f"{abs(data['birth'])}"
        ...
        self.stdout.write(
            self.style.SUCCESS(
                "--- MVP Data Load Complete. 8 Figures, 8 Influences Ready. ---"
            )
        )
